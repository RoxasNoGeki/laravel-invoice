...
{{--                        ERROR SECTION--}}
                        <div class="alert alert-danger" id="alertError" hidden="hidden">
...
{{--                        END NOTIF TIME + username input--}}
                        ...
                        <form id="verification-code-form" action="#">
                            ...
                            <input type="text" value="" placeholder="CODE" class="form-control" name="verification-code"
...
{{--                             Sign-in button --}}
                            ...
                            <button class="btn btn-primary" type="submit" id="verify-code-button">Verify</button>
                        ...
                        <div hidden="hidden">
                            <form method="POST" action="{{route('verifying')}}">
                                ...
                                <button type="submit" class="btn btn-fill btn-info btn-wd" id="update-timestamp">Sign In</button>
                            </form>
                        </div>
